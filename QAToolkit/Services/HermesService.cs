        ...
        private (string BaseUrl, string ApiKey, string Model) ResolveProvider(HermesUserSettings? userSettings)
        {
            if (userSettings != null && !string.IsNullOrWhiteSpace(userSettings.ApiKey))
            {
                return userSettings.Provider switch
                {
                    "Gemini"      => ("https://generativelanguage.googleapis.com/v1beta/openai/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "gemini-2.0-flash"),
                    "Cerebras"    => ("https://api.cerebras.ai/v1/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "llama-3.3-70b"),
                    "OpenRouter"  => ("https://openrouter.ai/api/v1/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "meta-llama/llama-3.3-70b-instruct:free"),
                    "SambaNova"   => ("https://api.sambanova.ai/v1/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "Meta-Llama-3.3-70B-Instruct"),
                    "Mistral"     => ("https://api.mistral.ai/v1/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "mistral-small-latest"),
                    "GitHub"      => ("https://models.inference.ai.azure.com/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "Meta-Llama-3.3-70B-Instruct"),
                    "Zhipu"       => ("https://open.bigmodel.cn/api/paas/v4/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "glm-4-flash"),
                    ...
                    _             => ("https://api.groq.com/openai/v1/",
                                      userSettings.ApiKey,
                                      userSettings.Model ?? "llama-3.1-8b-instant")
                };
            }
            ...
            return (_config["Hermes:Provider"] ?? "Groq") switch
            {
                "Gemini"     => ("https://generativelanguage.googleapis.com/v1beta/openai/",
                                 ...
                                 _config["Hermes:GeminiModel"] ?? "gemini-2.0-flash"),
                "Cerebras"   => ("https://api.cerebras.ai/v1/",
                                 _config["Hermes:CerebrasApiKey"] ?? "",
                                 _config["Hermes:CerebrasModel"] ?? "llama-3.3-70b"),
                "OpenRouter" => ("https://openrouter.ai/api/v1/",
                                 _config["Hermes:OpenRouterApiKey"] ?? "",
                                 _config["Hermes:OpenRouterModel"] ?? "meta-llama/llama-3.3-70b-instruct:free"),
                "SambaNova"  => ("https://api.sambanova.ai/v1/",
                                 _config["Hermes:SambaNovaApiKey"] ?? "",
                                 _config["Hermes:SambaNovaModel"] ?? "Meta-Llama-3.3-70B-Instruct"),
                "Mistral"    => ("https://api.mistral.ai/v1/",
                                 _config["Hermes:MistralApiKey"] ?? "",
                                 _config["Hermes:MistralModel"] ?? "mistral-small-latest"),
                "GitHub"     => ("https://models.inference.ai.azure.com/",
                                 _config["Hermes:GitHubToken"] ?? "",
                                 _config["Hermes:GitHubModel"] ?? "Meta-Llama-3.3-70B-Instruct"),
                "Zhipu"      => ("https://open.bigmodel.cn/api/paas/v4/",
                                 _config["Hermes:ZhipuApiKey"] ?? "",
                                 _config["Hermes:ZhipuModel"] ?? "glm-4-flash"),
                "Proxy"      => (_config["Hermes:ProxyUrl"] ?? "http://localhost:3001/v1/",
                                 _config["Hermes:ProxyApiKey"] ?? "no-key",
                                 _config["Hermes:ProxyModel"] ?? "llama-3.3-70b-versatile"),
                _            => ("https://api.groq.com/openai/v1/",
                                 _config["Hermes:GroqApiKey"] ?? "",
                                 _config["Hermes:GroqModel"] ?? "llama-3.1-8b-instant")
            };
        }
